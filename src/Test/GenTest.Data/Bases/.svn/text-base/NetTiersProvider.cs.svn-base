	...
	public abstract class NetTiersProvider : System.Configuration.Provider.ProviderBase
	{
        ...
        public override void Initialize(string name, NameValueCollection config)
	    {
	        ...
	        lock(syncObject)
            {
				...
				{
                    entityCreationalFactoryType = typeof(GenTest.Entities.EntityFactory);
				}
				else
				{
		...
		///<summary>
		/// Current FatturaProviderBase instance.
		///</summary>
		public virtual FatturaProviderBase FatturaProvider{get {throw new NotImplementedException();}}
		
		///<summary>
		/// Current RigaFatturaProviderBase instance.
		///</summary>
		public virtual RigaFatturaProviderBase RigaFatturaProvider{get {throw new NotImplementedException();}}
