...
public partial class FatturaFormPresenter
		{
		    ...
		    {
				((WebUserControls.BOM.Fattura)dataobject).Commit();
			...
			{
				var bo = WebUserControls.BOM.Fattura.RetrieveByUId(uid);
				if (bo == null) throw new BONotFoundException<WebUserControls.BOM.Fattura>(uid);
				bo.Remove();
				bo.Commit();
			}
		}
