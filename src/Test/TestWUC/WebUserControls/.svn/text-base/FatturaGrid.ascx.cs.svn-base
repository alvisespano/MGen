//
        ...
        {
            private GenTest.WebUserControls.BOM.Fattura bo;
            ...
            protected internal FatturaGridDataObject(GenTest.WebUserControls.BOM.Fattura bo)
            {
                this.bo = bo;
            }
...
public partial class FatturaGridPresenter : GridPresenterBase<FatturaGridDataObject, GenTest.WebUserControls.BOM.Fattura, GenTest.WebUserControls.BOM.Transaction>
		{
			...
			{
				 return GenTest.WebUserControls.BOM.Fattura.RetrieveByUId(uid);
			}	
		}
