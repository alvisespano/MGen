...
public partial class FatturaGridPresenter : GridPresenterBase<FatturaGridDataObject, GenTest.BOM.Fattura, GenTest.BOM.Transaction>
		{
			...
			{
				 return GenTest.BOM.Fattura.RetrieveByUId(uid);
			}	
		}
