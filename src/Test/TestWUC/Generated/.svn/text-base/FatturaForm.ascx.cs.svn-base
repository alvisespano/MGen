...
namespace GenTest.WebUserControls
{
    ...
    public partial class FatturaFormDataObject
    {
        ...
        protected internal FatturaFormDataObject(GenTest.BOM.Fattura bo)
        {
            this.bo = bo;
        }
    ...
    public partial class FatturaFormPresenter : FormPresenterBase<FatturaFormDataObject, GenTest.BOM.Fattura, GenTest.BOM.Transaction>
    {
        protected internal FatturaFormPresenter(IFormView<FatturaFormDataObject> view) : base(view) { }

        public void Fill(int uid)
        {
            view.DataObject = new FatturaFormDataObject(GenTest.BOM.Fattura.RetrieveByUId(uid));
        }
    }
